...
public  class HorCatAdapter extends RecyclerView.Adapter<HorCatAdapter.MyViewHolder> {
    ProgressDialog progressDialog;
    ArrayList<Modelhorcat> arrayList;
    ...
    public HorCatAdapter()
    {

    }


    public HorCatAdapter(ArrayList<Modelhorcat> arrayList, Context context) {
...
//        }
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v=inflater.inflate(R.layout.mscat,parent,false);
        final HorCatAdapter.MyViewHolder myViewHolder = new HorCatAdapter.MyViewHolder(v);
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int position) {
        Modelhorcat model = arrayList.get(position);
        Glide.with(context)
                .load(model.getImage())
      ...
      String my= arrayList.get(position).getSname();
